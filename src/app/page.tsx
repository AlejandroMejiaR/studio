  ...
  return (
    <>
      ...
      <section className="container mx-auto px-4 py-20 md:py-32 text-center">
        <h1 className="font-headline text-5xl sm:text-6xl md:text-7xl font-bold mb-6 text-primary animate-slideInLeftWithTerminalBounce">
        ...
        <p className="text-xl md:text-2xl text-foreground/80 max-w-3xl mx-auto mb-10 min-h-[3em] sm:min-h-[2.5em]"> {/* Added min-h to prevent layout shift */}
          <TypingAnimation
            text={heroSubtitle}
            speed={30} 
            startDelay={500} // Optional: delay before animation starts
          />
        </p>
