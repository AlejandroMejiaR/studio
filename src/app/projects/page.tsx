...
import { LanguageProvider, translations } from '@/contexts/LanguageContext'; // We need translations directly
...
export default async function AllProjectsPage() {
  ...
  return (
    // We wrap with LanguageProvider here to provide context to BackButton and ProjectCard
    <LanguageProvider>
