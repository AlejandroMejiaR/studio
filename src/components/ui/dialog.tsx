...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {/* The default close button was here and has been removed to prevent duplication. */}
      {/* The custom close button is now handled within the component that uses DialogContent, like ProjectDetailView. */}
    </DialogPrimitive.Content>
  </DialogPortal>
))
