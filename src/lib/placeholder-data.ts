...
export const placeholderProjects: Project[] = [
  {
    ...
    repoUrl: '#',
    priority: 1,
    en: { ...enDetails, title: 'Placeholder Project 1' },
    es: { ...esDetails, title: 'Proyecto de Ejemplo 1' },
  },
  {
    id: '2',
    ...
    repoUrl: '#',
    priority: 2,
    en: { ...enDetails, title: 'Placeholder Project 2' },
    es: { ...esDetails, title: 'Proyecto de Ejemplo 2' },
  },
  {
    id: '3',
    ...
    repoUrl: '#',
    priority: 3,
    en: { ...enDetails, title: 'Placeholder Project 3' },
    es: { ...esDetails, title: 'Proyecto de Ejemplo 3' },
  },
];
